...
as begin
	 ...
	 EstadoCivil=@EstadoCivil,FechaNac=@FechaNac,Especialidad=@Especialidad,Genero=@Genero,NumeroColegiado=@NumeroColegiado 
 ...
 as begin
	update Usuario set Contrasena=@Contrasena where CodigoEmpleado= @CodigoEmpleado
end
...
@Telefono VARCHAR(10),@EstadoCivil VARCHAR(10),@FechaNac DATETIME,@Genero VARCHAR(1)
as begin
	...
	Telefono=@Telefono,EstadoCivil=@EstadoCivil,FechaNac=@FechaNac,Genero=@Genero,Direccion=@Direccion
...
as begin
	delete from Expediente where NumeroExpediente=@NumeroExpediente
end
...
as begin
	 ...
	 @Especialidad, @Genero, @NumeroColegiado )
 end
 ...
 @CodigoEmpleado INT,@Contrasena VARCHAR(15)
 as begin
	insert into Usuario values (@CodigoEmpleado,@Contrasena)
end
...
as begin
	INSERT INTO Expediente (NumeroIdentidadPaciente, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Direccion, Telefono, EstadoCivil, FechaNac,Genero) 
	VALUES (@NumeroIdentidadPaciente, @Primer_Nombre, @Segundo_Nombre, @Primer_Apellido, @Segundo_Apellido, @Direccion, @Telefono, @EstadoCivil, @FechaNac, @Genero)
end
